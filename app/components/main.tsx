    ...
    return (
        <>
                ...
                */}
                <MainFlexContainer>
                <Header />
                <div className="container self-center flex flex-col justify-start items-start gap-[50px] pt-[25px] border-0 border-b-2 boder-solid border-neutral-500 m-auto bg-limeade-50 dark:bg-limeade-950">
                    <div className="flex flex-row gap-4">
                        <a href="https://shawnlawn.com">
                            <img className=" hover:ring-rose-500 focus:ring-rose-500 hover:ring-4 focus:ring-4 grow-2 shrink-0 border-0 border-r-2 border-neutral-500 border-solid px-10" src="https://img1.wsimg.com/isteam/ip/369b5ff8-e315-4151-9d33-e4bd5646e324/Screenshot_20220625-164121_Chrome~2.jpg/:/rs=w:300,h:425"/>
                        </a>
                    ...
                    <div className="flex self-center pb-[25px] pt-[-75px]">
                        <a href="mailto:shawn@shawnlawn.com"><button className="p-2 bg-limeade-400 dark:bg-limeade-600 hover:bg-limeade-200 focus:bg-limeade-200 dark:hover:bg-limeade-300 dark:focus:bg-limeade-300 rounded-full self-center text-center text-black font-black hover:ring-rose-500 focus:ring-rose-500 hover:ring-4 focus:ring-4">Schedule a FREE consultation</button></a>
                    </div>
                </div>
                <div className="container flex flex-col justify-start items-center dark:text-limeade-100 py-2 border-0 border-b-2 border-neutral-500 m-auto bg-emerald-50 dark:bg-emerald-950 gap-4">
                    <p className="flex self-center text-[#aa4e00]">Email me at <br/> {/* 
